...
​       **特别注意，各位师傅使用本工具请从github下载，从其他渠道下载工具，若被下毒与本作者无关，未经作者允许，研究对本工具进行编译，二开**

### 3.更新日志

| 2025.1.5  | 修复了信息查询的备案信息查询，子域名查询接口失效的问题，更新了zoomeye的新版本接口，新增了零零信安的信息系统，域名，移动应用3个资产测绘查询接口，并完善响应的批量导出功能。优化导出界面默认全选所有查询结果。优化了一些使用过程中的其他bug. |
| --------- | ------------------------------------------------------------ |
...
![image-20241103122515488](Readme.assets/image-20241103122515488.png)
